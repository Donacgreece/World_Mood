# World Mood live backend

World Mood intentionally ships with no fake public activity. Shared map data starts only after a real Supabase project is connected.
...
4. From the World Mood source folder run `setup-live-backend.ps1`.
